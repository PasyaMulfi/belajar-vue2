  ...
  <div class="grid grid-cols-4 gap-4" >
      <div  class="mx-8 my-8"> 
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">
          ...
          We thoroughly check every purchase you make and applies our company's 
        </p>
    ...
    <div class="mx-8 my-8"> <the-card variant="image" img-src="crocsclassic.jpg" img-alt="Desk">
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">
          ...
          Authentic. Guaranteed.
           ...
           <p class="ml-12 font-bold text-lime-700">IDR 2.900.000</p>
      </the-card>
    </div>
    <div class="mx-8 my-8">
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">
           ...
           <p class="ml-12 font-bold text-lime-700">IDR 1.650.000</p>
      </the-card>
    </div>
</div>
          <center>
        ...
        <div class="mx-8 my-8">
         <the-card variant="image" img-src="conversewhite.jpg" img-alt="Desk">
            ...
            <p class="font-normal text-gray-700 dark:text-gray-400">
               Please Make Sure The Size Fits You.
                  Authentic. Guaranteed.
                  We thoroughly check every purchase you make and applies our company
            </p>
               <p class="ml-12 font-bold text-lime-700">IDR 600.000</p>
          </the-card>
          </div>
          <div class="mx-8 my-8">
             <the-card variant="image" img-src="sk8atmos.jpg" img-alt="Desk">
                ...
                <p class="font-normal text-gray-700 dark:text-gray-400">
                    Please Make Sure The Size Fits You.
                      Authentic. Guaranteed.
                      We thoroughly check every purchase you make and applies our company's guarantee to the product's legitimacy     
                </p>
                   <p class="ml-12 font-bold text-lime-700">IDR 900.000</p>
              </the-card>
          </div>
          <div class="mx-8 my-8">
             <the-card variant="image" img-src="travisscootCACTUS.jpg" img-alt="Desk">
                ...
                <p class="font-normal text-gray-700 dark:text-gray-400">
                 ...
                 Authentic. Guaranteed.
                   ...
                   <p class="ml-12 font-bold text-lime-700">IDR 2.000.000</p>
              </the-card>
              </div>
              <div class="mx-8 my-8">
             <the-card variant="image" img-src="nb574.jpg" img-alt="Desk">
                ...
                <p class="font-normal text-gray-700 dark:text-gray-400">
                  Please Make Sure The Size Fits You.
                   Authentic. Guaranteed.
                   We thoroughly check every purchase you make and applies our company's guarante
                </p>
                   <p class="ml-12 font-bold text-lime-700">IDR 800.000</p>
              </the-card>
              </div>
     </div>
      ...
      <div class="grid grid-cols-4 gap-4">
         <div class="mx-8 my-8">
                 ...
                 <the-card variant="image" img-src="nb.jpg" img-alt="Desk">
                    ...
                    <p class="ml-12 font-bold text-lime-700">IDR 2.200.000</p>
                  </the-card>
                 ...
                 <the-card variant="image" img-src="spiderman.jpg" img-alt="Desk">
                    ...
                    <p class="font-normal text-gray-700 dark:text-gray-400">
                      Here are the biggest enter
                       ...
                       <p class="ml-12 font-bold text-lime-700">IDR 3.700.000</p>
                  </the-card>
                  </div>
                   <div class="mx-8 my-8">
                 <the-card variant="image" img-src="travisscoot.jpg" img-alt="Desk">
                    ...
                    <p class="font-normal text-gray-700 dark:text-gray-400">
                      Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.
                       ...
                       <p class="ml-12 font-bold text-lime-700">IDR 17.000.000</p>
                  </the-card>
                  </div>        
      </div>
